...
// Nodemailer Setup (ensure your credentials are correct)
const transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
        user: 'zabaazcreations@gmail.com',
        pass: 'bzcs gwlt zdzf ehjn'
    }
});
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: 0 auto;">
                <tr>
                    <td align="center" style="padding: 20px 0;">
                        <img src="https://i.ibb.co/7j5x202/dramakan-logo.png" alt="DramaKan Logo" width="150">
                    </td>
                </tr>
                <tr>
...
app.put('/api/profile', authenticateToken, (req, res) => {
    ...
    // Create a new token with the potentially updated username
...
app.put('/api/profile/picture', authenticateToken, (req, res) => {
    const { profilePicture } = req.body; // Expecting a Base64 string
    const userIndex = users.findIndex(u => u.email === req.user.email);
...
app.post('/api/profile/watchlist', authenticateToken, (req, res) => {
    ...
    if (dramaIndex > -1) { // If it exists, remove it
        ...
        res.json({ success: true, message: "Added to watchlist", inWatchlist: true });
    }
